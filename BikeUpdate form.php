...
<body>
    ...
    <nav class="navbar navbar-default" data-spy="affix" data-offset-top="60">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <font color="white"> <h4>Update Information</h4></font>
            </div>
	...
	<div class="search">
	    <ul>
		    <li><div class="slot">
	<form action="Bike Update insert date.php" method="post">
	 <p>
   ...
   <input type="submit" value="Ok">
			...
			<li><div class="slot1">
	<form action="Bike Update insert AT.php" method="post">
	 <p>
        <label for="Bike_no">Bike No</label>
        <input type="text" name="Bike_no" id="Bike_no">
    </p>
   ...
   <input type="submit" value="Ok">
			...
			<li><div class="slot2">
	<form action="Bike Update insert DT.php" method="post">
	 <p>
        <label for="Bike_no">Bike No</label>
        <input type="text" name="Bike_no" id="Bike_no">
    </p>
                            ...
                            <div class="banner-text-content">
                                ...
                                <div class="button-group">
                                   <!-- <a class="btn btn-lg" href="">Update</a>-->
                                    <!--<a class="btn btn-lg btn-border video-play"href="">Update</a>-->
                                </div>
                            </div>
                        </div>
