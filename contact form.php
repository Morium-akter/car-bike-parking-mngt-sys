    ...
    <nav class="navbar navbar-default" data-spy="affix" data-offset-top="60">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <font color="white"> <h4>Contact Information</h4></font>
            </div>
	    ...
	    <ul>
		   <li><div class="slot2">
		     <font color="black" ><center> <h4><b>Address of Organization</b></h4></center></font>
			 <font color="black" > <h5>Org: global concept ltd</h5></font>
			 <font color="black" > <h5>House 117,block C,road 13/B, banani,dhaka</h5></font>
			 <font color="black" > <h5>Contact  no: 01711310954</h5></font>
		      </div></li>
                        ...
                        <div class="col-md-7">
                            <div class="banner-text-content">
                                ...
                                <!--<div class="button-group">
                                    <a class="btn btn-lg" href="">Update price</a>
