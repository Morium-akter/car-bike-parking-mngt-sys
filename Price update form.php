...
<head>
	...
	<link rel="stylesheet" href="Price_update_style.css">
    ...
    <nav class="navbar navbar-default" data-spy="affix" data-offset-top="60">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <font color="white"> <h4>Update car pricing</h4></font>
            </div>
...
<div class="search">
	    <ul>
		    <li><div class="slot">
	<form action="Price update insert.php" method="post">
	 
    <p>
        <label for="Per hour car price">Per hour car price</label>
        <input type="text" name="per_hour" id="per_hour">
    </p>
   ...
   <input type="submit" value="Ok">
			...
			<li><div class="slot1">
	<form action="price update insertday.php" method="post">
	 
    <p>
        <label for="Per day car price">Per day car price</label>
        <input type="text" name="per_day" id="per_day">
    </p>
   ...
   <input type="submit" value="Ok">
      ...
      <li><div class="slot2">
	<form action="bike price insert.php" method="post">
	 
    <p>
        <label for="Per Hour bike price">Per hour bike price</label>
        <input type="text" name="per_hour" id="per_hour">
    </p>
   ...
   <input type="submit" value="Ok">
     ...
     <li><div class="slot3">
	<form action="bike price insertday.php" method="post">
	 
    <p>
        <label for="Per day bike price">Per day bike price</label>
        <input type="text" name="per_day" id="per_day">
    </p>
