...
<body>
    ...
    <nav class="navbar navbar-default" data-spy="affix" data-offset-top="60">
        ...
        <!--</div>
        <!-- /.container-fluid -->
		echo "<table id='t01' border='20' cellpadding='15'align='center'font color='black' >";
        echo "<tr>  <th>Car no</th><th>Car Name</th><th>Car Type</th><th>Car Owner Id</th><th>Car Owner Number</th> ";
echo"<center><b><i><u><br><br>Car Information </center></i></u></br></br>";
                            ...
                            <div class="banner-text-content">
                               <!-- <h1 class="banner-title">Car parking managment system <br/>Global lamia</h1>
                                ...
                                <!--<div class="button-group">
                                    <a class="btn btn-lg" href="Update form.php">Update</a>
