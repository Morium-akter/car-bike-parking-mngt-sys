...
<body>
    ...
    <nav class="navbar navbar-default" data-spy="affix" data-offset-top="60">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <font color="white"> <h4>Car Reservation Slot</h4></font>
            </div>
	...
	<div class="car">
	    <ul>
		    <li><div class="car1"><a href="car_slot_booking.php">S1</a></div><div class="car2">
			Available</div><div class="car3">3p.m</div></li>
			<li><div class="car1"><a href="car_slot_booking.php">S2</a></div><div class="car2">
			Available</div><div class="car3">3p.m</div></li>
			<li><div class="car1"><a href="car_slot_booking.php">S3</a></div><div class="car2">
			Available</div><div class="car3">3p.m</div></li>
			<li><div class="car1"><a href="car_slot_booking.php">S4</a></div><div class="car2">
			Available</div><div class="car3">3p.m</div></li>
			<li><div class="car1"><a href="car_slot_booking.php">S5</a></div><div class="car2">
			Available</div><div class="car3">3p.m</div></li>
			<li><div class="car1"><a href="car_slot_booking.php">S6</a></div><div class="car2">
			Available</div><div class="car3">3p.m</div></li>
			<li><div class="car1"><a href="car_slot_booking.php">S7</a></div><div class="car2">
			Available</div><div class="car3">3p.m</div></li>
			<li><div class="car1"><a href="car_slot_booking.php">S8</a></div><div class="car2">
			Available</div><div class="car3">3p.m</div></li>
			<li><div class="car1"><a href="car_slot_booking.php">S9</a></div><div class="car2">
			Available</div><div class="car3">3p.m</div></li>
			<li><div class="car1"><a href="car_slot_booking.php">S10</a></div><div class="car2">
			Available</div><div class="car3">3p.m</div></li>
	...
	<center>
		<div class="amulance">
			<p>The slote is not available. Input New Slot Number Bellow!!</p>
			
			<form action="ds_search_two.php" method="POST">						
				Slot Number &nbsp;&nbsp;&nbsp;&nbsp; : <input type="text" name="searchKeyword" value="" style="background:black; width:300px;"><br>
