    ...
    <nav class="navbar navbar-default" data-spy="affix" data-offset-top="60">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <!--<font color="white"> <h4>Information Search</h4></font>-->
            </div>
...
$Bike_no = mysqli_real_escape_string($con, $_REQUEST['Bike_no']);
$result = mysqli_query($con,"SELECT * FROM bike_slot_book WHERE Bike_no='$Bike_no'");

$q="SELECT * From payment_bike WhERE Bike_no='$Bike_no'";
...
echo "<table id='t01' border='5' cellpadding=''align='center'background-color='white'>";
        echo "<tr>  <th><font color='white' align='center'>Car no</font></th><th><font color='white' align='center'>Car Owner Name</font></th><th><font color='white' align='center'>Arrival Time</font></th><th><font color='white' align='center'>Departure Time<font></th><th><font color='white' align='center'>Date </font></th><th><font color='white' align='center'>Charge<font></th><th><font color='white' align='center'>Payment<font></th> ";		

echo"<center><b><br><br><font color='white'><h4>Bike Information</font></h4></b> </center></br></br>";
while($row = mysqli_fetch_array($result)) 
	{
		
		echo "<tr>"; 
		
                echo '<td style="color:blue" align="center";>' . $row['Bike_no'] . '</td>';
				echo '<td style="color:blue" align="center";>' . $row['Bike_owner_name'] . '</td>';
				echo '<td style="color:blue" align="center";>' . $row['Arrival_Time'] . '</td>';
                echo '<td style="color:blue" align="center";>' . $row['Departure_Time'] . '</td>';
                echo '<td style="color:blue" align="center";>' . $row['Date'] . '</td>';
				echo '<td style="color:blue" align="center";>' . $row['Charge'] . '</td>';
				echo '<td style="color:blue" align="center";>' . $p . '</td>';
	}
  echo "</tr>";
