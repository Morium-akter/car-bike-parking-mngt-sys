...
<head>
	...
	<link rel="stylesheet" href="Afetr_submit.css">
...
<body>
    ...
    <nav class="navbar navbar-default" data-spy="affix" data-offset-top="60">
                    ...
                    <div class="row">
                        <div class="col-md-100">
                            <div class="banner-text">
                                <h1 >Slot booked successfully <br/> Charge is </h1>
									...
									<?php
										...
										$searchKeyword = $_POST["Bike_no"];
										
										$SQL = "SELECT * FROM `bike_slot_book` WHERE `Bike_no` = $searchKeyword";
        ...
        <!--</div>
        <!-- /.container-fluid -->
		<a  href="payment bike form.php">Payment</a>
    </nav>
    <!-- Navigation End -->
