    ...
    <nav class="navbar navbar-default" data-spy="affix" data-offset-top="60">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <font color="white"> <h4>Price Information</h4></font>
            </div>
            ...
            <!--<div class="collapse navbar-collapse" id="navbar-collapse">
				...
				<ul>
				    ...
				    <li><a >Update</a>
					<ul>
					      <li><a href="Car Update form.php">Car</a></li>
					      <li><a href="BikeUpdate form.php">Bike</a></li>
					  </ul>
					</li>
				    <li><a >Search</a>
					<ul>
					      <li><a href="Car Search form.php">Car</a></li>
					      <li><a href="Bike Search form.php">Bike</a></li>
					  </ul>
					</li>
				    <li><a href="">Pricing</a>
				    ...
				    <li><a >Cancelation</a>
					<ul>
					      <li><a href="Car cancellation.php">Car</a></li>
					      <li><a href="Bike cancellation.php">Bike</a></li>
					  </ul>
					</li>
				    <li><a >Booking</a>
					  <ul>
	    ...
	    <ul>
		   <li><div class="slot2">
		     <font color="black" > <h5>For Car, Per hour price=<?php
...
$result = mysqli_query($con,"SELECT * FROM car_price");
...
mysqli_close($con);
?>TK </h5></font>
			 <font color="black" > <h5>For Car, Per day price=<?php
$con=mysqli_connect("localhost","root","","cpms");
// Check connection
if (mysqli_connect_errno()) {
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
...
mysqli_close($con);
?>Tk</h5></font>
			 <font color="black" > <h5>For bike, Per hour price=<?php
$con=mysqli_connect("localhost","root","","cpms");
...
mysqli_close($con);
?>TK </h5></font>
			 <font color="black" > <h5>For Bike, Per day price=<?php
$con=mysqli_connect("localhost","root","","cpms");
// Check connection
$q="SELECT * From bike_price";
$data=mysqli_query($con,$q);
                        ...
                        <div class="col-md-7">
                            <div class="banner-text-content">
                                ...
                                <div class="button-group">
                                    <a class="btn btn-lg" href="Price update form.php">Update price</a>
                                    <!--<a class="btn btn-lg btn-border video-play"href=""></a>-->
                                </div>
                            </div>
                        </div>
